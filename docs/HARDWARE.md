...
El firmware 0.1.0 apunta a Waveshare ESP32-S3-Touch-LCD-1.54 mediante el entorno
...
acepta las primitivas de `IRenderer`. El renderer físico sigue siendo no-op: el
